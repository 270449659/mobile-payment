...
/***/ 72:
/*!*************************************************************************!*\
  !*** D:/uniApp/mobile-payment/main.js?{"page":"pages%2Flogin%2Flogin"} ***!
  \*************************************************************************/
...
/***/ 73:
/*!******************************************************!*\
  !*** D:/uniApp/mobile-payment/pages/login/login.vue ***!
  \******************************************************/
/*! no static exports found */
...
/***/ 74:
/*!*************************************************************************************!*\
  !*** D:/uniApp/mobile-payment/pages/login/login.vue?vue&type=template&id=b237504c& ***!
  \*************************************************************************************/
...
/***/ 75:
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--16-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/uniApp/mobile-payment/pages/login/login.vue?vue&type=template&id=b237504c& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 76:
/*!*******************************************************************************!*\
  !*** D:/uniApp/mobile-payment/pages/login/login.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 77:
/*!**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/uniApp/mobile-payment/pages/login/login.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
//
//
var graceChecker = __webpack_require__(/*! @/common/graceChecker.js */ 78);var _default = { data: function data() {return { imageURL: '/static/images/user/login-background.png', title: 'Hello', userName: '', //用户账号
      password: '', //密码
      pwdInputType: 'password', //密码输入类型
      passwordBtn_type: true, //隐藏或显示密码
      sendVerify: '', //验证码
      button_type: true, //获取验证码按钮
      codeBtn: { text: '获取验证码' }, button_text: '10s重发', passwordLogin: true, //密码登录
      verificationBtn: true, //验证码按钮
      tips: true, //忘记密码或忘记验证码
      formIndex: 0 //登录按钮
    };}, components: {}, onLoad: function onLoad() {//设备宽度			
    var windowWidth = uni.getSystemInfoSync();console.log('windowWidth', windowWidth);}, methods: { passwordCode: function passwordCode(index) {//console.log('index',index)
      this.button_type = index;if (index) {this.pwdInputType = "password";} else {this.pwdInputType = "text";} //console.log('pwdinput',this.pwdInputType)
    ...
    formSubmit: function formSubmit(e) {var rule = [{ name: "userName", checkType: "notnull", checkRule: " ", errorMsg: "用户名不能为空" }, // {name:"mobile", checkType : "phoneno", checkRule:" ",  errorMsg:"手机号码不正确"},
      { name: "password", checkType: "notnull", checkRule: "", errorMsg: "密码不能为空" }];var rule_Verify = [{ name: "mobile", checkType: "notnull", checkRule: " ", errorMsg: "手机号码不能为空" }, { name: "mobile", checkType: "phoneno", checkRule: " ", errorMsg: "手机号码不正确" }, { name: "sendVerify", checkType: "notnull", checkRule: "", errorMsg: "验证码不正确" }];var formIndex = this.formIndex;if (0 == formIndex) {//进行表单检查
        var formData = e.detail.value;console.log(formData);var checkRes = graceChecker.check(formData, rule);if (checkRes) {this.$store.dispatch('userPwdLogin', { username: e.detail.value.userName, password: e.detail.value.password }); //uni.reLaunch({
          //	url:'/pages/home/home'
          //});
        } else {uni.showToast({ title: graceChecker.error, icon: "none" });}} else if (1 == formIndex) {//进行表单检查
        var formData = e.detail.value; //console.log(formData)
        var _checkRes = graceChecker.check(formData, rule_Verify);if (_checkRes) {// uni.reLaunch({
          // 	url:'/pages/home/home'
          // });
        } else {uni.showToast({ title: graceChecker.error, icon: "none" });}}}, // 提交登录 end
    // 验证码登录
    pushPath: function pushPath(e) {var type = e.currentTarget.dataset.type;console.log('type', type);if (type === 'verification') {
        this.formIndex = 1;
      ...
      if (checkRes) {
        ...
        if (res == 'success') {
          ...
          var timer = setInterval(function () {
            second--;
            if (second) {
              _this.button_text = +second + 's重发';
            } else {
              _this.codeBtn.text = '重新发送';
              _this.button_type = true;
              clearInterval(timer);
            }
          }, 1000);
        }
...
/***/ 79:
/*!***************************************************************************************!*\
  !*** D:/uniApp/mobile-payment/pages/login/login.vue?vue&type=style&index=0&lang=css& ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 80:
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--6-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--6-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--6-oneOf-1-2!./node_modules/postcss-loader/src??ref--6-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/uniApp/mobile-payment/pages/login/login.vue?vue&type=style&index=0&lang=css& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
